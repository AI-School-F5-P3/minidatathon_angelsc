...
# Agregar el layout a la aplicación Bokeh
curdoc().add_root(layout)

# Iniciar la aplicación Bokeh
if __name__ == "__main__":
    print("Iniciando la aplicación Bokeh...")
    curdoc().title = "Mapa de Incremento de Muertes por COVID-19 en EE.UU."
    curdoc().serve(port=5006)
